...
class DBInterface extends Connection {
    ...
    public function saveKunde($vorname,$name,$strasse,$hausnr,$plz,$ort,$land) {
      try {
          $db = $this->getConnection();
          $stmt = $db->query("INSERT INTO kunde (vorname,name,strasse,hausnr,plz,ort,land) VALUES ('$vorname','$name','$strasse','$hausnr','$plz','$ort','$land')");
